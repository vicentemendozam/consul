...
feature 'Internal valuation comments on Budget::Investments' do
  ...
  context "Valuation comments flagging" do
    let!(:comment) { create(:comment, :valuation, author: valuator_user, commentable: investment) }
    ...
    scenario "Flagging as inappropriate", :js do
      ...
      expect(Flag.flagged?(valuator_user, comment)).to be
    end

    scenario "Undoing flagging as inappropriate", :js do
      Flag.flag(valuator_user, comment)
      ...
      expect(Flag.flagged?(valuator_user, comment)).not_to be
    end
  end
